 ...
 *
 * Implementation of Newlib syscalls and setup/teardown for IRVE S-Mode programs (uses the SBI)
 *
...
void _exit(int) {
    irve_exit();//TODO use the SBI instead
}
...
int _isatty(int) {
    return 1;//Since we only support stdout output via the SBI
}
