...
aclint::aclint_t::aclint_t(CSR::CSR_t& csrs) : m_csrs(csrs) {}

word_t aclint::aclint_t::read(uint16_t register_address) {
...
void aclint::aclint_t::write(uint16_t register_address, word_t data) {
    assert(((register_address & 0b11) == 0) && "Unaligned access to ACLINT");
