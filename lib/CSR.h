...
public:
    ...
    */
    reg_t explicit_read(uint16_t csr);//Not constant due to possible read side effects
    ...
    */
     ...
     * @return      The value of the CSR.
    */
    reg_t implicit_read(uint16_t csr);//Not constant due to possible read side effects
