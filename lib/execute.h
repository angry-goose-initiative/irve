...
namespace irve::internal::execute {
    ...
    void jalr    (const decode::decoded_inst_t& decoded_inst, CpuState& cpu_state,                           const Csr& CSR);
    void jal     (const decode::decoded_inst_t& decoded_inst, CpuState& cpu_state,                           const Csr& CSR);
